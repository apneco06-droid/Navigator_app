...
const navigator_programs_json_1 = __importDefault(require("../../navigator-programs.json"));
...
exports.programs = navigator_programs_json_1.default.map((program) => ({
    ...program,
    jurisdictions: jurisdictionMap[program.id] ?? ["texas", "federal-us", "new-mexico"],
